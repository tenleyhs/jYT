...
ds = [
    ...
    ['m1.0_p1_b1.0',        '0100',     15,     -1.4,	-0.1],
    ['m1.0_p1_b1.0_pfe',    '0100',     15,     -1.4,	-0.1],
	['m1.0_p1_b1.5',		'0040',		10,		-1.65,	0.1],
    ['m1.0_p1_b1.5',		'0090',		10,		-1.65,	0.1],
	['m1.0_p1_b1.75',		'0040',		15,		-1.75,	-0.35],
    ['m1.0_p1_b1.75',		'0090',		15,		-1.75,	-0.35],
	['m1.0_p1_b2.0',		'0040',		25,		-1.8,	-0.65],
    ['m1.0_p1_b2.0',		'0080',		25,		-1.8,	-0.65],
	['m1.0_p1_b3.0',		'0040',		15,		-1.9,	-0.3],
    ['m1.0_p1_b3.0',		'0060',		15,		-1.9,	-0.3],
    # p10
	['m1.0_p10_b1.0',		'0040',     20,     -1.3,	-0.3],
    ['m1.0_p10_b1.0',		'0100',     20,     -1.3,	-0.3],
	['m1.0_p10_b1.0_256',	'0040',     35,     -1.3,	-0.15],
    ['m1.0_p10_b1.0_256',	'0100',     35,     -1.3,	-0.15],
	['m1.0_p10_b1.5',		'0040',     20,     -1.65,	-0.3],
    ['m1.0_p10_b1.5',		'0090',     20,     -1.65,	-0.3],
	['m1.0_p10_b2.0',		'0040',     25,     -1.8,	-0.1],
    ['m1.0_p10_b2.0',		'0075',     25,     -1.8,	-0.1],
	['m1.0_p10_b2.0_256',	'0040',     50,     -1.8,	3],
    ['m1.0_p10_b2.0_256',	'0080',     50,     -1.8,	3],
	['m1.0_p10_b2.5',		'0040',     20,     -1.9,	-0.3],
    ['m1.0_p10_b2.5',		'0060',     20,     -1.9,	-0.3],
	['m1.0_p10_b3.0',		'0040',     20,     -2,	    -0.4],
    ['m1.0_p10_b3.0',		'0060',     20,     -2,	    -0.4],
    ['m1.0_p10_b3.0_256',   '0057',     20,     -2,	    -0.4],
	['m1.0_p10_b4.0',		'0040',     40,     -2,	    2],
    ['m1.0_p10_b4.0',		'0050',     40,     -2,	    2],
    # p16
	['m1.0_p16_b1.0',		'0040',     50,     -1.1,	2],
    ['m1.0_p16_b1.0',		'0100',     50,     -1.1,	2],
    ['m1.0_p16_b1.0_pfe',	'0052',     50,     -1.1,	2],
	['m1.0_p16_b1.5',		'0040',     50,     -1.5,	2],
    ['m1.0_p16_b1.5',		'0090',     50,     -1.5,	2],
	['m1.0_p16_b2.0',		'0040',     30,     -1.65,	2],
    ['m1.0_p16_b2.0',		'0075',     30,     -1.65,	2],
	['m1.0_p16_b3.0',		'0040',     50,     -1.85,	2],
    ['m1.0_p16_b3.0',		'0060',     50,     -1.85,	2],
	['m1.0_p16_b4.0',		'0040',     30,     -2,	    2],
    ['m1.0_p16_b4.0',		'0050',     30,     -2,	    2],
]
