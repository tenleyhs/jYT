"""
experimental. making this at first to compare a few mdots made from different chks
this will start out as plotting for all mdot related plots
"""
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
plots = [
    # run, chk,
    ['m1.0_p1_b1.0', '0040', 0.8*80.78, 1e-5*80.78],
    ['m1.0_p1_b1.0', '0100', 0.8*169.88, 1e-5*169.88],
]
for plot in plots:
    ds = yt.load('/pfs/lawsmith/FLASH4.3/runs/'+plot[0]+'/multitidal_hdf5_chk_'+plot[1])
