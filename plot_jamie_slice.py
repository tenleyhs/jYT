...
plots = [
    ['m1.0_p1_b2.0', '0230', 0.8*80.78, 1e-5*80.78, 'age = 0Gyr'],
    ['m1.0_p10_b2.0', '0230', 0.8*169.88, 1e-5*169.88, 'age = 4.8Gyr'],
    ['m1.0_p16_b2.0', '0230', 0.8*500, 1e-5*500, 'age = 8.4Gyr'],
]
...
for plot in plots:
    ...
    s.save('/pfs/lawsmith/FLASH4.3/runs/results/paper/' + plot[0].replace(".","_") + '_' + plot[1] + '.pdf')
